...
export default function ProfilBelokSidan() {
  return (
    <>
      <Typography variant="h5" sx={{ fontWeight: 'bold', marginBottom: 2, marginLeft: 13, marginRight: 6}}>
        Asal Usul Desa Belok/Sidan
      </Typography>

      <Typography variant="body1" sx={{ marginBottom: 2, textAlign: 'justify', marginLeft: 13, marginRight: 13 }}>
      ...
      <Typography variant="body1" sx={{ textAlign: 'justify', marginLeft: 13, marginRight: 13 }}>
