    ...
    return (
        <div className={'overflow-hidden'}>
            <div className="h-[52rem] absolute top-0 left-0 w-full overflow-hidden">
                <Image fill sizes="auto" className="object-cover min-w-96" src="/tukad-bangkung.webp" alt="Jembatan Tukad Bangkung"/>
                <div className="absolute inset-0 z-1 opacity-75 bg-[linear-gradient(180deg,rgba(0,0,0,0.50)_49.65%,rgba(0,0,0,0.00)_100%)]"></div>
                {/* <div className="absolute z-10 bottom-0 inset-x-0 h-[10rem] bg-[linear-gradient(180deg,rgba(255,255,255,0)_20%,#FFF_100%)] dark:bg-[linear-gradient(180deg,rgba(9,9,11,0)_20%,#09090b_100%)] lg:backdrop-blur-[0.5px]"></div> */}
            </div>
            <div className="container relative z-10">
                <div className="relative rounded-b-md rounded-t-3xl lg:rounded-t-4xl min-h-[48rem]">
                    <div className="absolute inset-0 overflow-y-clip">
                        ...
                        <Image
                            ...
                            alt="Travel Hero Cloud Image"
                        /> */}
                        <div className="absolute left-1/2 -translate-x-1/2 top-48 z-3 flex flex-col items-center gap-y-4">
                            ...
                            <div className="title bg-[linear-gradient(180deg,#FFF_-16.99%,rgba(255,255,255,0.7)_100%)] text-3xl lg:text-8xl leading-none whitespace-nowrap">
                                <span className="font-pinyon text-8xl lg:text-[18rem] !font-normal">B</span><span className="text-5xl lg:text-[9rem]">elok ke </span>
                                <span className="font-pinyon text-8xl lg:text-[18rem] !font-normal">P</span><span className="text-5xl lg:text-[9rem]">elaga</span>
                            </div>
                        </div>
                    </div>
                </div>
                <BukanSponsor  labelClass="text-surface-500" iconClass="[&_path]:fill-surface-500" />
            </div>
        </div>
    );
};
