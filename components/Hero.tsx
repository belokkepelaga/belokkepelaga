    ...
    return (
        <AnimatedContainer className={'overflow-hidden'}>
            <div className="h-[52rem] absolute left-0 w-full overflow-hidden">
                <Image fill sizes="auto" className="object-cover min-w-96" src="/tukad-bangkung.png" alt="Travel Hero Background Image" />
                <div className="absolute inset-0 z-1 opacity-75 bg-[linear-gradient(180deg,rgba(0,0,0,0.50)_49.65%,rgba(0,0,0,0.00)_100%)]"></div>
                {/* <div className="absolute lg:opacity-100 opacity-50 z-10 bottom-0 inset-x-0 h-[16rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.00)_0%,#FFF_62.59%,#FFF_100%)] dark:bg-[linear-gradient(180deg,rgba(9,9,11,0.00)_0%,rgba(9,9,11,0.8)_62.59%,rgba(9,9,11,1)_100%)] lg:backdrop-blur-[0.75px]"></div> */}
            </div>
