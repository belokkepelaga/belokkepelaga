...
const Hero = () => {
    return (
        <AnimatedContainer className={'overflow-hidden'}>
            <div className="h-[52rem] absolute left-0 w-full overflow-hidden">
                ...
                {/* <div className="absolute lg:opacity-100 opacity-50 z-10 bottom-0 inset-x-0 h-[16rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.00)_0%,#FFF_62.59%,#FFF_100%)] dark:bg-[linear-gradient(180deg,rgba(9,9,11,0.00)_0%,rgba(9,9,11,0.8)_62.59%,rgba(9,9,11,1)_100%)] lg:backdrop-blur-[0.5px]"></div> */}
            </div>
